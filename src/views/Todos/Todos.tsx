...
export default function Todos() {
          ...
          <div className="flex items-center text-lg text-slate-900 dark:text-slate-300 p-2">
            {
              todo.isDone
                ...
                : <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="red" className="w-5 h-5 mr-1">
  ...
  return (
    <div className="my-4 mx-4">
      <h2 className="text-center mb-1 text-slate-900 dark:text-white mt-5 text-base font-medium tracking-tight">
        {'TODO LIST'}
      </h2>
